...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="container">
        <div class="innerdiv">
            <div class="row"><img   class="imglogo" src="https://www.edubull.com/Products/LMS/images/lms_banner.jpg"/></div>
            <div class="leftinnerdiv">
                ...
                <Button class="greenbtn" onclick="openpart('addperson')"> ADD STUDENT/TEACHER</Button>
            ...
            <Button class="greenbtn" >BOOK REQUEST APPROVE
            ...
            <div>Branch:<input type="radio" name="branch" value="other"/>other<input type="radio" name="branch" value="Computer"/>Computer<div style="margin-left:80px">
            <input type="radio" name="branch" value="Mechanical"/>Mechanical<input type="radio" name="branch" value="ENTC"/>ENTC</div>
            </div>   
            ...
            $table="<table style='font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;'><tr><th style='  border: 1px solid #ddd;
            padding: 8px;'> Name</th><th>Email</th><th>Type</th><th>Delete Record</th></tr>";
            foreach($recordSet->fetch_all() as $row){
                $table.="<tr>";
               "<td>$row[0]</td>";
                $table.="<td>$row[1]</td>";
                $table.="<td>$row[2]</td>";
                $table.="<td>$row[4]</td>";
                 $table.="<td> <a href='deleteuser.php?useriddelete=$row[0]'><button type='button' class='btn btn-primary'>Delete</button></a>
                </td>";
                $table.="</tr>";
                // $table.=$row[0];
            }
        ...
        <div class="rightinnerdiv"> 
            ...
            <div id="bookdetail" class="innerright portion" style=
            "<?php  if(!empty($_REQUEST['viewid']))
 ...
 <img width='150px' height='150px' style='border:1px solid #333333; float:left;margin-left:20px' src="uploads/<?php echo $bookimg?> "/>
           ...
           foreach($recordSet->fetch_all() as $row){
              ...
              "<td>$row[0]</td>";
               ...
               $table.="<td> <a href='deletebook.php?deletebookid=$row[0]'><button type='button' class='btn btn-primary'>Delete</button></a></td>";
               $table.="</tr>";
               // $table.=$row[0];
           }
           $table.="</table>";
           ...
           ?>
            ...
            $table="<table style='font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 110%;'><tr><th style='  border: 1px solid #ddd;
            padding: 8px;'> Issue Email</th><th>Book Name</th><th>Issue Date</th><th>Return Date</th><th>Fine</th></th><th>Issue Type</th></tr>";
            foreach($recordSet->fetch_all() as $row){
                $table.="<tr>";
               "<td>$row[0]</td>";
               $table.="<td>$row[2]</td>";
